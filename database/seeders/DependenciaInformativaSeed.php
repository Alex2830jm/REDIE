...
class DependenciaInformativaSeed extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $dependenciasEstatales = [
            ...
            /* 32 */["numDI" => '4',    "nombreDI" => 'Secretaría de Salud', "padreDI" => '0', "nivelDI" => '1'],
            /* 33 */["numDI" => '4.0',  "nombreDI" => 'Unidad de Información, Planeación, Programación y Evaluación de la Secretaría de Salud', "padreDI" => '32', "nivelDI" => '2'],
            /* 34 */["numDI" => '4.1',  "nombreDI" => 'Insituto de Salud del Estado de México (ISEM)', "padreDI" => '32', "nivelDI" => '2'],
            /* 35 */["numDI" => '4.2',  "nombreDI" => 'Sistema para el Desarrollo Integral de la Familia (DIFEM)', "padreDI" => '32', "nivelDI" => '2'],
            /* 36 */["numDI" => '4.3',  "nombreDI" => 'Instituto Materno Infamtil del Estado de México (IMIEM)', "padreDI" => '32', "nivelDI" => '2'],
            /* 37 */["numDI" => '4.4',  "nombreDI" => 'Instituto Mexicano del Seguro Social (IMSS-OTE)', "padreDI" => '32', "nivelDI" => '2'],
            /* 38 */["numDI" => '4.5',  "nombreDI" => 'Instituto Mexicano del Seguro Social (IMSS-PTE)', "padreDI" => '32', "nivelDI" => '2'],
            /* 39 */["numDI" => '4.6',  "nombreDI" => 'Delegación del Instituto de Seguridad y Servicios Sociales de los Taabajadores del Estado (ISSTE)', "padreDI" => '32', "nivelDI" => '2'],
            /* 40 */["numDI" => '4.7',  "nombreDI" => 'Instituto de Seguridad Social Social del Estado de México y Municipios (ISSEMyN)', "padreDI" => '32', "nivelDI" => '2'],

            /* 41 */["numDI" => '5',    "nombreDI" => 'Secretaría del Trabajo', "padreDI" => '0', "nivelDI" => '1'],
            /* 42 */["numDI" => '5.0',  "nombreDI" => 'Unidad de Información, Planeación, Programación y Evaluación', "padreDI" => '41', "nivelDI" => '2'],
            /* 43 */["numDI" => '5.1',  "nombreDI" => 'Dirección General de Empleo y Productividad', "padreDI" => '41', "nivelDI" => '2'],
            /* 44 */["numDI" => '5.2',  "nombreDI" => 'Instituto de Capacitación y Adiestramiento para el Trbajo Industrial (ICATI)', "padreDI" => '41', "nivelDI" => '2'],
            /* 45 */["numDI" => '5.3',  "nombreDI" => 'Junta local de Conciliación y Arbitraje del Valle Cuatitlan-Texcoco', "padreDI" => '41', "nivelDI" => '2'],
            /* 46 */["numDI" => '5.4',  "nombreDI" => 'Junta local de Conciliación y Arbitraje del Valle de Toluca', "padreDI" => '41', "nivelDI" => '2'],

            /* 47 */["numDI" => '6',    "nombreDI" => 'Secretaría de Educación, Ciencia, Tecnología e Innovación', "padreDI" => '0', "nivelDI" => '1'],
            /* 48 */["numDI" => '6.0',  "nombreDI" => 'Dirección General de Información, Planeación, Programación y Evaluación', "padreDI" => '48', "nivelDI" => '2'],
            /* 49 */["numDI" => '6.1',  "nombreDI" => 'Dirección de Información y Planeación', "padreDI" => '48', "nivelDI" => '2'],
            /* 50 */["numDI" => '6.2',  "nombreDI" => 'Dirección General de Cultura Física y Deporte', "padreDI" => '48', "nivelDI" => '2'],

            /* 51 */["numDI" => '7',    "nombreDI" => 'Secretaría de Bienestar', "padreDI" => '1', "nivelDI" => '1'],
            /* 52 */["numDI" => '7.0',  "nombreDI" => 'Unidad de Información, Planeación, Programación y Evaluación', "padreDI" => '51', "nivelDI" => '2'],
            /* 53 */["numDI" => '7.1',  "nombreDI" => 'Junta de Asistencia Privada del Estado de México', "padreDI" => '51', "nivelDI" => '2'],
            /* 54 */["numDI" => '7.2',  "nombreDI" => 'Consejo Estatal para el Desarrollo Integral de los Pueblos Indígenas del Estado de México (CEDIPIEM)', "padreDI" => '51', "nivelDI" => '2'],
            
            /* 55 */["numDI" => '8',    "nombreDI" => 'Secretaría de Desarrollo Urbano e Infraestructura', "padreDI" => '0', "nivelDI" => '1'],
            /* 56 */["numDI" => '8.0',  "nombreDI" => 'Unidad De Información, Planeación, Programación y Evaluación ', "padreDI" => '55', "nivelDI" => '2'],
            /* 57 */["numDI" => '8.1',  "nombreDI" => 'Dirección de Operación Urbana', "padreDI" => '55', "nivelDI" => '2'],
            /* 58 */["numDI" => '8.2',  "nombreDI" => 'Dirección de Promoción y Fomento a la Vivienda', "padreDI" => '55', "nivelDI" => '2'],

            /* 59 */["numDI" => '9',    "nombreDI" => 'Secretaría del Campo', "padreDI" => '0', "nivelDI" => '1'],
            /* 60 */["numDI" => '9.0',  "nombreDI" => 'Unidad de Información, Planeación, Programación y Evaluación ', "padreDI" => '59', "nivelDI" => '2'],
            /* 61 */["numDI" => '9.1',  "nombreDI" => 'PROBOSQUE', "padreDI" => '59', "nivelDI" => '2'],

            /* 62 */["numDI" => '10',   "nombreDI" => 'Secretaría de Desarrollo Economico', "padreDI" => '0', "nivelDI" => '1'],
            /* 63 */["numDI" => '10.0', "nombreDI" => 'Unidad de Planeación e Igualdad de Género ', "padreDI" => '62', "nivelDI" => '2'],
            /* 64 */["numDI" => '10.1', "nombreDI" => 'Dirección General de Comercio', "padreDI" => '62', "nivelDI" => '2'],
            /* 65 */["numDI" => '10.2', "nombreDI" => 'Dirección General del Instituto de Fomento Minero y Estudios Geológicos del Estado De México', "padreDI" => '62', "nivelDI" => '2'],

            /* 66 */["numDI" => '11',   "nombreDI" => 'Secretaría de Cultura y Turismo', "padreDI" => '0', "nivelDI" => '1'],
            /* 67 */["numDI" => '11.0', "nombreDI" => 'Unidad de Planeación, Programación y Evaluación', "padreDI" => '66', "nivelDI" => '2'],
            /* 68 */["numDI" => '11.1', "nombreDI" => 'Dirección General del Instituto Mexiquense de Cultura (IMC)', "padreDI" => '66', "nivelDI" => '2'],
            /* 70 */["numDI" => '11.3', "nombreDI" => 'Dirección General de Turismo', "padreDI" => '66', "nivelDI" => '2'],
            /* 71 */["numDI" => '11.4', "nombreDI" => 'Instituto de Investigación y Fomento de las Artesanias del Estado de México', "padreDI" => '66', "nivelDI" => '2'],
