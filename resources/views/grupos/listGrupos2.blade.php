...
<div x-data="{
        ...
        switch (type) {
            ...
            case 'dependencia':
                $.get(`{{ route('directorio.areas') }}?unidad_id=${valor}`, (areas) => {
                    $('#areas').empty();
                    //$('#areas').append('<option value=``>Selecciona una dependencia</option>');
    ...
    <div class="px-4 md:flex py-3">
        <ul class="flex-column space-y space-y-6 font-medium text-gray-500 md:me-4 mb-4 md:mb-0">
            <li>
                <label for="grupo_2_1"
                    ...
                    <input type="radio" name="grupo_id" id="grupo_2_1" value="2" class="sr-only"
                        @click="searchContent($event)" />
                </label>
            </li>
            <li>
                <label for="grupo_14_2"
                    ...
                    <input type="radio" name="grupo_id" id="grupo_14_2" value="14" class="sr-only"
                        @click="searchContent($event)" />
                </label>
            </li>
            <li>
                <label for="grupo_32_3"
                    ...
                    <input type="radio" name="grupo_id" id="grupo_32_3" value="32" class="sr-only"
                        @click="searchContent($event)" />
                </label>
            </li>
            <li>
                <label for="grupo_37_4"
                    ...
                    <input type="radio" name="grupo_id" id="grupo_37_4" value="37" class="sr-only"
                        @click="searchContent($event)" />
                </label>
            </li>
        </ul>
