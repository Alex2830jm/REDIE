        ...
        <div x-cloak :class="[openMenu ? 'translate-x-0 opacity-100 ' : 'opacity-0 -translate-x-full']"
            ...
            <div class="flex flex-col md:flex-row md:mx-6">
                ...
                <x-dropdown aling="left">
                    <x-slot name="trigger">
                        <button
                            class="flex items-center gap-2 p-2 my-2 transition-colors duration-300 transform rounded-md md:mx-4 md:my-0">
                            <div class="relative flex items-center">
                    ...
                    <x-slot name="content">
                        <x-dropdown-link>
                            <div class="mx-1">
                                <h1 class="text-sm">
                                    {{ Auth::user()->name }}</h1>
                                <p class="text-sm text-gold-400">{{ Auth::user()->username }}</p>
                            </div>
                        </x-dropdown-link>
