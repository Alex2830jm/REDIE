                    ...
                    <div class="border-b-2 py-4">
                        ...
                        <div class="flex flex-col md:flex-row md:items-center md:justify-between">
                            <div class="flex-1">
                                ...
                                <div x-show="step === 3">
                                    <div class="text-lg font-bold text-gray-700 leading-tight">Temas Asignados al Rol
                                    </div>
                                </div>
                            </div>
                    ...
                    <div x-show.transition.in="step === 1">
                        ...
                        <div class="mt-3 relative">
                            <label for="nameRole"
                                ...
                                <input type="text" id="nameRole" name="nameRole"
                        ...
                        <div class="relative">
                            <label for="descriptionRole"
                                ...
                                <input type="text" id="descriptionRole" name="descriptionRole"
                                    class="mt-1 w-full border-none p-0 focus:border-transparent focus:outline-none focus:ring-0 sm:text-sm" />
                        ...
                        <div class="flex justify-between">
                            ...
                            <label for="checkAllTemas" class="flex cursor-pointer items-start gap-4">
                                <div class="flex items-center">
                                    &#8203;
                                    <input type="checkbox" class="size-4 rounded border-gray-300" id="checkAllTemas" />
                                </div>
                                <div>
                                ...
                                @foreach ($grupos as $grupo)
                                    <div
                                        ...
                                        <div class="flex items-center justify-between mb-4">
                                            <h5 class="text-xl text-center font-bold leading-none text-{{ $grupo->colorGrupo}}-500">
                                                {{ $grupo->nombreGrupo }}
                                            </h5>
                                        </div>
                                        <div class="flow-root">
                                                    ...
                                                    <li class="py-3 sm:py-4">
                                                        <div class="flex items-center">
                                                            <div class="flex-1 min-w-0 ms-4">
                                                                ...
                                                                <p class="text-sm text-{{$grupo->colorGrupo}}-500 truncate">
                                                                    {{ $sector->nombreGrupo }}
                                                                </p>
                                                                @foreach ($sector->temas as $tema)
                                                                    <ul
                                                                        ...
                                                                        <li
                                                                            ...
                                                                            <div class="flex items-center ps-3 rounded-lg has-[:checked]:ring-2 has-[:checked]:ring-{{ $tema->padre->padre->colorGrupo }}-500 has-[:checked]:text-{{ $tema->padre->padre->colorGrupo }}-400">
                                                                                ...
                                                                                <input id="tema_id{{$tema->id}}"
                                                                                    type="checkbox" value="{{$tema->id}}"
                                                                                    name="tema_id[]"
