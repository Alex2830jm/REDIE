    ...
    <div class="md:container md:mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-12 p-4 gap-4 items-center">
            ...
            <div class="col-span-1 md:col-span-5 flex items-center justify-between">
                ...
                <div class="hidden lg:flex overflow-x-auto overflow-y-hidden justify-end whitespace-nowrap">
                    <div class="flex overflow-x-auto overflow-y-hidden justify-end whitespace-nowrap">
