            ...
            <dl class="divide-y divide-gray-300 text-sm">
                <div class="flex p-3 bg-cherry-800 even:bg-gray-50 sm:justify-between items-center">
                    <span class=" text-base md:text-xl lg:text-2xl text-white mx-auto">
                        {{ $informantes->areaPersona == '1' || $informantes->areaPersona == '3' ? 'Titular de '  : 'Enlace de Información' }} {{ $informantes->dependencia->nombreDI }}
                    </span>
    ...
    <x-modal name="editDatosInformante" maxWidth="5xl">
        <div class="header my-3 h-12 px-10 flex items-center justify-between">
            <h1 class="font-medium text-2xl">
                ...
                <span x-text="(dataInformante.areaPersona === '1' || dataInformante.areaPersona === '3' ? 'Titular de ' : 'Enlace de información de ') + (dataInformante.dependencia?.nombreDI ?? '')"></span>
                ...
                <div class="flex">
                    <div class="mb-5 mr-2 w-full sm:w-1/2">
                        <label for="" class="block mb-2 text-sm font-medium text-gray-900"> Área
                            Informante: </label>
                        <input type="text" id="areaPersona" name="areaPersona"
                            x-model="dataInformante.areaPersona === '1' || dataInformante.areaPersona === '3' ? 'Titular de ' + dataInformante.dependencia.nombreDI : 'Enlace de información de ' + dataInformante.dependencia.nombreDI"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                            readonly>
                    </div>
                    ...
                    <div class="mb-5 mr-2 w-full sm:w-1/2">
                        ...
                        <label for="inputPhone"
                            ...
                            <span
                                ...
                                x-text="dataInformante.dependencia?.numTelefonoDI ? dataInformante.dependencia.numTelefonoDI + ' EXT.' : ''">
                            </span>
                        </label>
                    </div>
