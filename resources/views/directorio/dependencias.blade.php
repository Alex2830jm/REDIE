<div class="px-4 pb-5 mt-10 grid gap-4 md:grid-cols-3 items-center justify-center self-center">
    @foreach ($dependencias as $dependencia)
        <div
            class="relative flex w-80 mb-10 flex-col rounded-xl bg-white bg-clip-border text-gray-700 shadow-md transition ease-in-out delay-75 duration-500 hover:translate-y-1 hover:scale-110">
            <div
            ...
            <div class="p-6 pt-0 justify-center">
                <a href="{{ route('directorio.unidades', $dependencia->id) }}"
