                            ...
                            <div x-show.transition.in="step === 1">
                                <div class="mt-5">
                                    <div class="mb-5">
                                        ...
                                        <input type="text" name="nameRole" id="nameRole" value="{{ $role->name }}"
                                    ...
                                    <div class="mb-5">
                                        ...
                                        <input type="text" name="descriptionRole" id="descriptionRole" value="{{ $role->description }}"
                                                                                ...
                                                                                <li
                                                                                    ...
                                                                                    <div
                                                                                        ...
                                                                                        <input
                                                                                            id="tema_id{{ $tema->id }}"
                                                                                            type="checkbox"
                                                                                            value="{{$tema->id }}" {{ $role->temas->contains($tema->id) ? 'checked' : ''}}
                                                                                            name="tema_id[]"
