...
<div x-data="{
    ...
    <div class="px-4 md:flex py-3">
        <ul class="flex-column space-y space-y-6 text-sm font-medium text-gray-500 md:me-4 mb-4 md:mb-0">
            <li>
                <label for="grupo_2_1" class="inline-flex items-center px-4 py-3 bg-white border-l-4 border-orange-500 rounded-lg w-full transition ease-in-out delay-75 sm:hover:translate-y-1 sm:hover:scale-110 sm:hover:text-orange-400 cursor-pointer has-[:checked]:border-orange-500 has-[:checked]:ring-1 has-[:checked]:ring-orange-500 has-[:checked]:text-orange-400">                    <svg class=" w-7 h-7 me-2" viewBox="0 0 640 512">
                        <path fill="#f97316"
