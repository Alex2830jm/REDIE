    ...
    <div class="flex h-screen">
        <div class="hidden lg:flex items-center justify-center flex-1 bg-white text-black">
            <div class="mx-w-md text-center">
                <img src="{{ asset('assets/img/dashboards/loginImage3.svg') }}" alt="">
        ...
        <div class="w-full bg-gray-100 lg:w-1/2 flex items-center justify-center">
            <div class="max-w-xl w-full p-6">
                <h1 class="text-5xl font-bold text-cherry-900 text-center"> Repositorio Digital de Información Estadística </h1>
                ...
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <div class="relative" x-data="{ showPassword: true}">
                        ...
                        <div class="flex items-center absolute inset-y-0 right-0 mt-6 mr-3 text-sm leading-5">
                            <svg @click="showPassword = !showPassword" :class="{ 'hidden': !showPassword, 'block': showPassword }" 
                                class="h-6 text-cherry-700"  fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M2.036 12.322a1.012 1.012 0 0 1 0-.639C3.423 7.51 7.36 4.5 12 4.5c4.638 0 8.573 3.007 9.963 7.178.07.207.07.431 0 .639C20.577 16.49 16.64 19.5 12 19.5c-4.638 0-8.573-3.007-9.963-7.178Z" />
                                <path stroke-linecap="round" stroke-linejoin="round" d="M15 12a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" />
                            </svg>

                            <svg @click="showPassword = !showPassword" :class="{ 'block': !showPassword, 'hidden': showPassword }" 
                                class="h-5 text-cherry-700" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
