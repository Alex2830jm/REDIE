...
<ul class="px-4 py-3 grid w-full gap-6 md:grid-cols-4">
    <li>
        <button type="button" id="grupo_1">
            <label for="1"
                ...
                <div class="bg-orange-600 p-3 flex items-center justify-center aspect-square w-16">
                    <svg class="h-3/4 w-3-4" viewBox="0 0 320 512">
                        <path fill="#ffffff"
        ...
        {{-- <input type="radio" id="grupo_1" value="1" class="hidden peer" name="grupo_id"
    ...
    <li>
        <button type="button" id="grupo_2">
            <label for="2"
                class="inline-flex items-center w-full rounded-md text-gray-500 bg-white border-2 border-sky-200 transition ease-in-out delay-75 hover:translate-y-1 hover:scale-110 cursor-pointer">
    ...
    <li>
        <button type="button" id="grupo_3">
            <label for="3"
                class="inline-flex items-center w-full rounded-md text-gray-500 bg-white border-2 border-green-200 transition ease-in-out delay-75 hover:translate-y-1 hover:scale-110 cursor-pointer">
    ...
    <li>
        <button type="button" id="grupo_4">
            <label for="4"
                class="inline-flex items-center w-full rounded-md text-gray-500 bg-white border-2 border-fuchsia-200 transition ease-in-out delay-75 hover:translate-y-1 hover:scale-110 cursor-pointer">
...
<div id="sectorGroup" x-transition:enter="transition ease-out duration-300"
