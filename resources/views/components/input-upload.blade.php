<div x-data="{
    ...
    <label id="select-image">
        <div class="flex items-center justify-center w-full mt-5">
            <div
                class="flex flex-col items-center justify-center w-full h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-100 hover:bg-gray-200">
