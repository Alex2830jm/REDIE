<section class="cointainer mx-auto" x-data="{
    openDrawer: false,
    ...
    <div class="relative w-full h-95">
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="p-3 text-xs text-gray-500">
                                {{-- <button id="ce_{{ $ce->id }}" value="{{ $ce->id }}"
                                    ...
                                    class="text-blue-600 text-xs hover:text-white border border-blue-600 hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg px-5 py-2.5 text-center me-2 mb-2">
                                    Ver Archivos
                                </button> --}}
                                <button id="ce_{{ $ce->id }}" value="{{ $ce->id }}"
                                    @click="contentCE($event)"
        ...
        <div x-show="openDrawer" x-transition:enter="transition-transform transform ease-out duration-300"
            ...
            <table class="w-full text-sm text-gray-500 items-center text-center">
                <thead>
                    ...
                    <tr>
                        <th scope="col" colspan="2">
                            <button id="addFile" @click="contentCE($event)"
                                class="inline-flex items-center px-4 py-2 bg-green-500 transition ease-in-out delay-75 hover:bg-green-600 text-white text-sm font-medium rounded-md hover:-translate-y-1 hover:scale-110">
                ...
                <tbody class="divide-y divide-gray-400" id="listFiles">
                </tbody>
            </table>
        </div>
    </div>
    ...
    <x-modal name="agregarArchivo" maxWidth="2xl" focusable>
        <div class="bg-white shadow px-4 pb-5 pt-5 sm:p-6 sm:pb-4">
            <div class="flex items-center justify-between">
                <h3 class="text-left font-bold text-2xl text-gray-800 m-3">
                    Agregar Archivo a Historial del Cuadro Estadístico
                </h3>
                <svg x-on:click="$dispatch('close')" xmlns="http://www.w3.org/2000/svg" fill="none"
                    viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
                    class="h-6 w-6 cursor-pointer hover:text-red-500">
