        ...
        {{-- <nav x-data="{ isOpen: false }" class="bg-header shadow">
            <div class="px-6 py-4 md:container md:mx-auto text-white md:flex md:justify-between md:items-center">
                <div class="flex items-center text-white justify-between">
                    ...
                    <div class="flex lg:hidden">
                        <button x-cloak @click="isOpen = !isOpen" type="button"
                            class="hover:text-secondary  focus:outline-none focus:text-white" aria-label="toggle menu">
                ...
                <div x-cloak :class="[isOpen ? 'translate-x-0 opacity-100 ' : 'opacity-0 -translate-x-full']"
                    class="absolute inset-x-0 z-20 w-full px-6 py-4 transition-all duration-300 ease-in-out bg-pink-800 border border-gold-400 sm:border-0 md:mt-0 md:p-0 md:top-0 md:relative md:bg-transparent md:w-auto md:opacity-100 md:translate-x-0 md:flex md:items-center">
                    <div class="flex flex-col md:flex-row md:mx-6">
                        <a class="my-2 transition-colors hover:text-gold-500 duration-300 transform md:mx-4 md:my-0"
                            href="#">
                        ...
                        <a class="my-2 transition-colors hover:text-gold-500 duration-300 transform hover:text-secondary md:mx-4 md:my-0"
                            href="#">
                            <div class="relative flex items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    stroke-width="1.5" stroke="currentColor" class="size-6">
